...
se basan en aproximadamente una hora de datos recolectados el 3 de diciembre de 2025
entre las 11:00 y las 12:00 (hora local).
...
en horas pico y en determinadas rutas troncales.
...
proporción de headways en cada categoría por ruta y por periodo del día, lo que
permite cuantificar la incidencia del \emph{bus bunching} y de las brechas de
servicio prolongadas.
...
menor longitud de recorridos cercanos por unidad de superficie.
...
conectada y con una red de segmentos de tránsito menos intensa.
...
velocidad observada es sistemáticamente menor o mayor que la prevista. Los
mapas y distribuciones de demoras por parada evidencian una cola hacia valores
positivos, con retrasos concentrados en ciertos corredores y horarios.

Finalmente, el análisis de headways revela una mezcla de intervalos “bunched”,
regulares y con grandes brechas, cuya distribución varía según la ruta y el
periodo del día. En conjunto, los resultados estáticos y en tiempo real ofrecen
