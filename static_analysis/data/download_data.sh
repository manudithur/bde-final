...
# Change to script directory (static_analysis/data/)
cd "$SCRIPT_DIR"
...
if [ -f "$GTFS_ZIP" ]; then
    ...
    echo "  - The file 'static_analysis/data/gtfs_vancouver.zip' exists, OR"
    echo "  - The directory 'static_analysis/data/gtfs_vancouver' exists"
